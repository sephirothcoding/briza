...
BUTTERFLY.prototype = {
	...
	render: function (context) {
		...
		for (var i = -1; i <= 1; i += 2) {
			...
			gradient.addColorStop(0.3, 'hsl(45, 100%, ' + (76 + 10 * rate) + '%)');
			gradient.addColorStop(0.5, 'hsl(45, 100%, ' + (76 + 20 * rate) + '%)');
			gradient.addColorStop(1, 'hsl(45, 100%, ' + (76 + 30 * rate) + '%)');
			context.lineWidth = 3;
			...
			context.beginPath();
			context.moveTo(-2, -10);
			context.bezierCurveTo(-5, -20, -3 - Math.sin(this.theta), -30, -8 - Math
